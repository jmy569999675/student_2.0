...
<?php include "leftmenu.php" ?>	  	
	...
	<!--技巧：增加一个隐藏的input,用来区分是新增记录还是修改记录-->
			  ...
			  <div class="control-group">
			    ...
			    <div class="controls">
			      <input type="text" id="snum" name="snum" class="input-large input-fat" placeholder="输入学生学号" data-rules="required|minlength=6|maxlength=6">
			    </div>
			  </div>				
			  <div class="control-group">
			  ...
			  <div class="control-group">
			    <label for="sName" class="control-label">上传照片：</label>
			    <div class="controls">
			      <input type="file" id="file" name="file" class="input-large input-fat" value="选择文件">
			    </div>
			  </div>
			  <div class="control-group">
